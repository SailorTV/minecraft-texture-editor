document.addEventListener('DOMContentLoaded', function () {
    ...
    const textureSequence = [
        ...
        'paladium_sword', 'paladium_green_sword', 'armure_paladium', 'armure_paladium_green'
    ...
    function loadImageGallery(resolution, textureType) {
        ...
        if (textureType === 'armure_paladium' || textureType === 'armure_paladium_green') {
            for (let i = 1; i <= 5; i++) {
                const img = document.createElement('img');
                img.src = `textures/${resolution}/${textureType}/image${i}.png`; // Afficher image pour chaque dossier
                img.alt = `${textureType} ${i}`;
                ...
                img.addEventListener('click', function () {
                    ...
                    armorPieces.forEach(piece => {
                        selectedTextures[piece] = `textures/${resolution}/${textureType}/armurepaladium${i}/${piece}.png`;
                    });
    ...
    async function downloadZips(urls, packName, resolution) {
        ...
        for (let i = 0; i < urls.length; i++) {
            ...
            if (imageBlob) {
                ...
                } else if (textureType === 'armure_paladium' || textureType === 'armure_paladium_green') {
                    const folderPath = `textures/${resolution}/${textureType}/armurepaladium${i}/`;
                    const armorPieces = ['paladium_boots', 'paladium_leggings', 'paladium_chestplate', 'paladium_helmet'];
